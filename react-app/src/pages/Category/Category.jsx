...
const Category = ({ match }) => {
    ...
    const handleLoadMore = () => setPage((page) => page)
                ...
                <>
                    ...
                    >
                        {selectedGenre.data &&
                            ...
                            selectedGenre.data.map((result) => <Poster key={result.id} item={result} {...result} />)}
                        ...
                        <div
                            className={`Category__endPage ${isIntersecting ? "intersected" : null}`}
                            ref={endPageRef}
                        />
                    </motion.div>
                </>
