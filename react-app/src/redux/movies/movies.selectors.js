...
export const selectActionMoviesSelector = createSelector([selectActionMovies], (actionMovies) => actionMovies.data)
...
export const selectComedyMoviesSelector = createSelector([selectComedyMovies], (comedyMovies) => comedyMovies.data)

export const selectHorrorMoviesSelector = createSelector([selectHorrorMovies], (horrorMovies) => horrorMovies.data)

export const selectNetflixMoviesSelector = createSelector([selectNetflixMovies], (netflixMovies) => netflixMovies.data)

export const selectRomanceMoviesSelector = createSelector([selectRomanceMovies], (romanceMovies) => romanceMovies.data)
...
export const selectLatestMoviesSelector = createSelector([selectLatestMovies], (latestMovies) => latestMovies.data)
